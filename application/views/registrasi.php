                ...
                <form method="POST" action="<?=base_url('login/regis')?>">
                  ...
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      <input id="password" type="text" class="form-control pwstrength" data-indicator="pwindicator" name="username">
                    ...
                    <div class="form-group col-6">
                      ...
                      <input id="password2" type="text" class="form-control" name="password">
                    </div>
                  </div>
